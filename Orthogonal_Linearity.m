...
%% Plot Final Weighted Linearity Over Time

figure;
plot(master_times, final_linearity_values, '-o', 'LineWidth', 1.5);
xlabel('Time (s)');
ylabel('Weighted Linearity (Avg. of Medians)');
title('Weighted Linearity over Time (20s Windows from Multiple Scales)');
ylim([0 1]);
grid on;
